...
export const createContact = async ({
  ...
  // Usa apenas a melhor informação disponível para fazer UMA ÚNICA chamada e economizar a cota da API do Google (evitando erro 429)
  const searchStr = telefone || email || nome;
  if (searchStr) {
    existingPerson = await searchBy(searchStr);
  }
