...
export default function LoginPage() {
 ...
 <Link href="/politicas" className="text-xs font-semibold text-gray-500 hover:text-gray-800 transition-colors uppercase tracking-wider">Pol�tica de Privacidade e Termos de Uso</Link>
 </div>
 </div>
 </div>
 </div>
