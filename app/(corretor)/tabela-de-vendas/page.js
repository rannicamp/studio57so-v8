  ...
  return (
    <div className="max-w-[1600px] mx-auto pb-12 w-full animate-fade-in relative">
                 ...
                 {empreendimentos.map(emp => (
                     <button
                        ...
                        className={`
                            ...
                            ${activeTab === emp.id 
                                ? 'bg-white text-blue-700 shadow-md ring-1 ring-black/5 transform scale-100' 
                                : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200/50 transform scale-95 origin-center'
                            }
                        `}
                     >
                        {emp.nome}
      ...
      <div className="px-4 sm:px-6 w-full">
        {activeTab && (
           <TabelaVendaCorretorAba 
              key={`tab-render-${activeTab}`} // O key obriga a montagem de um componente 100% fresco ao tocar a aba para blindar viciamento de estado
              empreendimentoId={activeTab} 
