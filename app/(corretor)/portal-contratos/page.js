...
import { createNewContrato, softDeleteContrato } from './actions'; import { formatDistanceToNow, isToday, isYesterday } from 'date-fns';
...
export default function ContratosPage() {
 ...
 setIsModalOpen(false); setSelectedEmpreendimentoId(''); setSelectedTipoDocumento('CONTRATO');
 };
 ...
 setIsCreating(true);
 try {
 const result = await createNewContrato(selectedEmpreendimentoId, selectedTipoDocumento); if (result?.success && result?.newContractId) {
 ...
 corretores={[]} produtos={filterData?.produtos || []}
