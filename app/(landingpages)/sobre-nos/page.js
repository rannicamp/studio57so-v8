...
export default function SobreNosPage() {
 ...
 <Image src="https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/empresa-anexos/4/LOGO-P_1765565958716.PNG" alt="Logo Studio 57" fill className="object-contain"
 priority
 />
 </div>
 ...
 <span className="text-sm font-bold tracking-[0.3em] text-blue-600 uppercase">Prólogo</span>
 ...
 <Image src="https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/empresa-anexos/4/IMG_1769106573052.png" alt="Ranniere Campos" fill
 className="object-cover object-top transition-transform duration-700 hover:scale-105" />
 </div>
 <h2 className="text-2xl font-bold text-gray-900 uppercase mb-2">Ranniere Campos</h2>
 <p className="text-sm text-blue-600 font-bold uppercase tracking-wider mb-6">A Visão Tecnológica</p>
 ...
 <p>
 Muita gente conta que começou a usar tecnologia porque teve uma 'visão mística' do futuro. A minha verdade é mais simples: em 2009, no terceiro período da faculdade, um professor me contou um segredo. Ele disse: <span className="block border-l-2 border-blue-600 pl-4 my-4 italic text-gray-800">
 ...
 <div className="flex flex-col">
 <div className="relative w-full h-[500px] mb-8 overflow-hidden">
 <Image src="https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/empresa-anexos/4/IMG_1769107378867.png" alt="Igor Monte Alto" fill
 className="object-cover object-top transition-transform duration-700 hover:scale-105" />
 </div>

 <h2 className="text-2xl font-bold text-gray-900 uppercase mb-2">Igor Monte Alto</h2>
 <p className="text-sm text-blue-600 font-bold uppercase tracking-wider mb-6">A Gestão e o Ensino</p>
 ...
 <Image src="https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/empresa-anexos/4/IMG_1769088852146.png" alt="Sócios Studio 57 - Identidade" width={0}
 height={0}
 sizes="100vw"
 ...
 <ul className="space-y-4 bg-white p-6 rounded-sm border-l-2 border-blue-600 shadow-sm">
 ...
 <li className="flex items-start">
 <FontAwesomeIcon icon={faHardHat} className="mt-1 mr-3 text-blue-600" />
 ...
 <Image src="https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/empresa-anexos/4/IMG_1769093097228.png" alt="Sócios Studio 57 - A Retomada" width={0}
 height={0}
 sizes="100vw"
 className="w-full h-auto transition-all duration-700"
 />
 ...
 <Link href="/empreendimentosstudio" className="bg-black hover:bg-gray-800 text-white font-bold py-4 px-10 rounded-full transition-all transform hover:scale-105 shadow-xl"
 >
 Ver Empreendimentos
 </Link>
 <Link href="https://wa.me/5533998192119?text=Olá! Vim pela página Sobre Nós do site e gostaria de conversar." target="_blank"
