...
export default function HomePage() {
 ...
 <Image src={empreendimento.imagemUrl}
 ...
 <button onClick={() => setIsRefugioModalOpen(true)}
 ...
 >
 <div className="relative w-full max-w-lg bg-gray-900 rounded-2xl shadow-2xl overflow-hidden border border-gray-700 animate-fade-in-up"
 onClick={(e) => e.stopPropagation()} // Impede fechar ao clicar dentro
 >
 {/* Cabeçalho do Modal com Botão Fechar */}
 <div className="absolute top-4 right-4 z-10">
 <button onClick={() => setIsRefugioModalOpen(false)}
