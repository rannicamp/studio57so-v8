...
export default function CtaSection() {
 ...
 O futuro da obra<br/>
 começa <span className="text-transparent bg-clip-text bg-blue-600 from-[#FF6700] ">agora.</span>
 </h2>
 <p className="text-xl text-gray-500 mb-12 font-light leading-relaxed">
 Não é apenas sobre software. É sobre ter o controle total nas suas mãos e o sorriso no rosto de quem sabe que a obra está no prazo. Acesse o BIM Manager e experimente o ecossistema <strong>Elo 57</strong>.
 </p>
 ...
 <img src={ENGINEER_IMAGE} alt="Engenheiro satisfeito utilizando Tablet na obra" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-1000 ease-in-out"
 />
 {/* Overlay suave para integrar com o branco do lado esquerdo */}
 <div className="absolute inset-y-0 left-0 w-32 bg-blue-600 from-white to-transparent hidden md:block"></div>
 {/* Overlay inferior para mobile */}
 <div className="absolute bottom-0 w-full h-24 bg-blue-600 from-white to-transparent md:hidden"></div>
 </div>
 </div>
