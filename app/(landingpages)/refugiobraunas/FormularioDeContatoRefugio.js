...
function SubmitButton() {
 ...
 return (
 <button type="submit" disabled={pending} // MUDANÇA: Cores Verdes (green-700 / green-800)
...
export default function FormularioDeContatoRefugio({ onClose }) {
 ...
 {/* Botão Fechar */}
 <button onClick={onClose} // MUDANÇA: Hover text-green-700
 ...
 <select onChange={(e) => setCountry(e.target.value)} value={country} // MUDANÇA: Focus ring-green-500
