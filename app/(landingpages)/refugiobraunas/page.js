// app/(landingpages)/refugiobraunas/page.js
'use client'
...
import {
  ...
  faBuildingColumns,
  faShieldHalved,
  // faDraftingGavel, // <-- ÍCONE REMOVIDO (NÃO EXISTE)
  faPencilRuler, // <-- ÍCONE ADICIONADO (CORREÇÃO)
  faMountainSun,
  faSackDollar,
  faChartLine,
  faTreeCity,
...
// CORREÇÃO AQUI: Trocando ícone inexistente
const IconeCasa = () => (
