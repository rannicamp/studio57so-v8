...
const AUTH_URL = '/api/aps/token'; export default function ViewerBackground({ urn }) {
 ...
 viewer.setQualityLevel(false, false); viewer.setGhosting(false);
 ...
 <Script src="https://developer.api.autodesk.com/modelderivative/v2/viewers/7.*/viewer3D.min.js" strategy="lazyOnload"
 />
