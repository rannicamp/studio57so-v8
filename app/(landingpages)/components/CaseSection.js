...
import ViewerBackground from './ViewerBackground'; export default function CaseSection() {
 ...
 <div className="absolute inset-0 bg-blue-600 from-white via-white/60 to-transparent z-10 pointer-events-none"></div>
 ...
 <img src="https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/empreendimento-anexos/1/IMG_1759018648180.png" alt="Fachada Alfa" className="w-full h-full object-cover rounded-lg"
 />
 ...
 <img src="https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/empreendimento-anexos/1/IMG_1759018929039.png" alt="Gourmet Alfa" className="w-full h-full object-cover rounded-lg"
 />
 ...
 <img src="https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/empreendimento-anexos/1/IMG_1759019089329.png" alt="Interior Alfa" className="w-full h-full object-cover rounded-lg"
 />
