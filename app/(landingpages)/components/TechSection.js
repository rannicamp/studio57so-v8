export default function TechSection() {
 ...
 <div key={index} className={`rounded-2xl p-6 border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 h-full flex flex-col ${index === 3 ? 'bg-black text-white border-gray-800' : 'bg-white border-gray-100 hover:border-gray-200'}`}
 >
 {/* Título do Módulo */}
