export default function OriginSection() {
 ...
 <img src={bgImage} alt="Comparativo: Mesa bagunçada vs Gestão digital Elo 57"
 className="w-full h-full object-cover opacity-60"
 />
 </div>

 {/* --- CAMADA 2: Degradê (Mais suave agora para combinar com a fonte fina) --- */}
 <div className="absolute inset-0 bg-blue-600 from-black via-black/80 to-transparent z-10" />
 ...
 "Para cumprir nossa promessa de <span className="text-white font-normal">Excelência em cada detalhe</span> precisamos ser <span className="text-white font-normal">Eficiêncientes em cada detalhe</span> </p>
 </div>
