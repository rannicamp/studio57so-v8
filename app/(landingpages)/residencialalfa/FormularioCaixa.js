...
function SubmitButton() {
 ...
 return (
 <button type="submit" disabled={pending} className="w-full bg-blue-800 text-white font-bold py-4 px-6 rounded-lg hover:bg-blue-900 disabled:opacity-70 transition-all duration-300 shadow-lg uppercase tracking-wider flex items-center justify-center text-sm"
 >
 {pending ? (
...
export default function FormularioCaixa({ onClose }) {
 ...
 <input type="text" id="nome" name="nome" required placeholder="Como no seu documento"
