...
export default function GeradorAnunciosProPage() {
 ...
 <div className="absolute bottom-0 left-0 w-full h-32 bg-blue-600 from-white to-transparent"></div>
 ...
 <div className="absolute inset-0 bg-blue-600 from-[#1a1a1a] via-[#1a1a1a]/80 to-transparent"></div>
...
function BotaoDownload({ index, loading, onClick, nome }) {
 return (
 <button onClick={() => onClick(index, nome)} disabled={loading}
