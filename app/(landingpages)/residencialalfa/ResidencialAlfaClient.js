...
import { Roboto, Montserrat } from 'next/font/google'; import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
...
const primaryColor = '#45301f'; const IconeLocalizacao = () => <FontAwesomeIcon icon={faLocationDot} className="w-8 h-8" />;
...
export default function ResidencialAlfaClient() {
 const [view, setView] = useState('investidor'); const [selectedImage, setSelectedImage] = useState(null);
