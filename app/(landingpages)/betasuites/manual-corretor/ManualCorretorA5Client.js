  ...
  return (
    <div className={`min-h-screen bg-neutral-900 py-10 print:py-0 print:bg-transparent ${montserrat.className}`}>
      ...
      <div className="pdf-book-container flex flex-col items-center">
        ...
        <FolhaA5Retrato isDark={true}>
          <div className="absolute inset-0 w-full h-full">
            <img 
              ...
              className="absolute inset-0 w-full h-full object-cover object-[65%_center] filter grayscale-[30%]"
            />
            <div className="absolute inset-0 bg-black/70"></div>
            <div className="absolute inset-0 bg-gradient-to-b from-[#f25a2f]/20 via-transparent to-black/90"></div>
          </div>
          ...
          <div className="relative w-full h-full flex flex-col items-center justify-center p-8 z-10 text-center">
            ...
            <h1 className={`${roboto.className} text-[1.6rem] font-light text-white uppercase tracking-[0.22em] leading-tight drop-shadow-2xl mb-6`}>
              Manual Tático<br/>Do Corretor
            </h1>
            <div className="w-full flex justify-center">
              <p className="text-gray-200 text-[9px] tracking-[0.5em] uppercase font-light drop-shadow-md text-center">
            ...
            <div className="absolute bottom-12 flex flex-col items-center">
               <img
                  ...
                  alt="Studio 57"
                  className="w-[100px] h-auto object-contain filter brightness-0 invert opacity-60 mb-2"
                />
               <p className="text-[12px] uppercase tracking-[0.2em] text-gray-400">Restrito a Parceiros Homologados</p>
            </div>
          </div>
        </FolhaA5Retrato>
        ...
        ======================================================== */}
        <FolhaA5Retrato isDark={true}>
          <div className="w-full h-full p-10 flex flex-col relative bg-[#0a0a0a]">
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#f25a2f] to-transparent"></div>
            
            <div className="mt-6 mb-8 flex items-center gap-3 border-b border-white/10 pb-4">
              <FontAwesomeIcon icon={faList} className="text-[#f25a2f] text-3xl" />
              <div>
                 <h2 className={`${roboto.className} text-2xl font-light text-white uppercase tracking-[0.1em] leading-none`}>Sumário</h2>
                 <p className="text-gray-400 text-[12px] font-bold uppercase tracking-widest mt-1">Índice Tático</p>
              </div>
            </div>
            ...
            <div className="flex-1 space-y-5 mt-4">
               <div className="border-l-2 border-white/10 pl-4 py-1">
                 ...
                 <p className="text-[12px] text-gray-400">A Máquina de Rentabilidade e a Marca Studio 57.</p>
               </div>
               <div className="border-l-2 border-white/10 pl-4 py-1">
                 <h3 className="text-[13px] text-[#f25a2f] font-bold uppercase tracking-widest mb-1">02. Raio-X do Empreendimento</h3>
                 <p className="text-[12px] text-gray-400">O Mapa do Ouro, Lazer Premium e Formato Suítes.</p>
               </div>
               <div className="border-l-2 border-white/10 pl-4 py-1">
                 <h3 className="text-[13px] text-[#f25a2f] font-bold uppercase tracking-widest mb-1">03. O Portal do Corretor Studio 57</h3>
                 <p className="text-[12px] text-gray-400">Seu Escritório Virtual: Tabelas, Documentos e Clientes.</p>
               </div>
               <div className="border-l-2 border-white/10 pl-4 py-1">
                 <h3 className="text-[13px] text-[#f25a2f] font-bold uppercase tracking-widest mb-1">04. Arquitetura Financeira</h3>
                 <p className="text-[12px] text-gray-400">Fluxo 20/40/40 e a Engrenagem do Aluguel.</p>
               </div>
               <div className="border-l-2 border-white/10 pl-4 py-1">
                 <h3 className="text-[13px] text-[#f25a2f] font-bold uppercase tracking-widest mb-1">05. Arsenal Tático (Objeções)</h3>
                 <p className="text-[12px] text-gray-400">Respostas prontas para vacância, tamanho e preço.</p>
               </div>
               <div className="border-l-2 border-white/10 pl-4 py-1">
                 <h3 className="text-[13px] text-[#f25a2f] font-bold uppercase tracking-widest mb-1">06. Fechamento e Suporte</h3>
                 <p className="text-[12px] text-gray-400">Mídias e Contatos de Atendimento Direto.</p>
               </div>
            </div>
            
            <div className="text-center mt-auto pt-4 border-t border-white/10">
               <p className="text-[12px] text-gray-500 font-bold uppercase tracking-widest">Manual do Corretor • Página 02</p>
            </div>
          </div>
        </FolhaA5Retrato>
            ...
            <div className="flex-1">
               ...
               <div className="w-full h-[120px] rounded-lg shadow-sm overflow-hidden border border-gray-200 mb-6 print:border-gray-300 relative bg-gray-100">
                 <iframe
                   ...
                   className="absolute -top-[65px] -left-[10px] w-[calc(100%+20px)] h-[250px] pointer-events-none"
        ...
        <FolhaA5Retrato isDark={true}>
          <div className="w-full h-full p-10 flex flex-col relative bg-[#0a0a0a]">
            ...
            <div className="mt-6 mb-8 flex items-center gap-3 border-b border-white/10 pb-4">
              ...
              <div>
                 <h2 className={`${roboto.className} text-2xl font-light text-white uppercase tracking-[0.1em] leading-none`}>Seu Escritório</h2>
                 <p className="text-gray-400 text-[12px] font-bold uppercase tracking-widest mt-1">O Portal do Corretor Studio 57</p>
              </div>
            </div>

            <div className="flex-1">
               <p className="text-[12px] text-gray-300 leading-[1.6] mb-8 text-justify">
               ...
               <ul className="space-y-5 mb-8">
                 <li className="flex items-start gap-4 bg-[#161616] p-4 rounded-lg border border-white/5">
                   <FontAwesomeIcon icon={faFilePdf} className="text-[#f25a2f] mt-1 text-[18px]" />
                   <div>
                     <h4 className="text-[12px] font-bold text-white uppercase tracking-wider mb-1">Tabelas & Documentos</h4>
                     <p className="text-[12px] text-gray-400 leading-[1.6]">Acesse a disponibilidade ao vivo, simule fluxos e baixe Matrículas, Alvarás, Memorial Descritivo e Contratos. Tudo juridicamente validado.</p>
                   </div>
                 </li>
                 <li className="flex items-start gap-4 bg-[#161616] p-4 rounded-lg border border-white/5">
                   <FontAwesomeIcon icon={faUsers} className="text-[#f25a2f] mt-1 text-[18px]" />
                   <div>
                     <h4 className="text-[12px] font-bold text-white uppercase tracking-wider mb-1">Gestão de Clientes</h4>
                     <p className="text-[12px] text-gray-400 leading-[1.6]">Registre seus atendimentos no Portal e preserve o comissionamento do seu funil (Lead Protection). A venda é sua.</p>
                   </div>
                 </li>
                 <li className="flex items-start gap-4 bg-[#161616] p-4 rounded-lg border border-white/5">
                   <FontAwesomeIcon icon={faLink} className="text-[#f25a2f] mt-1 text-[18px]" />
                   <div>
                     <h4 className="text-[12px] font-bold text-white uppercase tracking-wider mb-1">Material de Marketing</h4>
                     <p className="text-[12px] text-gray-400 leading-[1.6]">Baixe os Renders em alta definição, Vídeos de Fachada e Plantas Humanizadas para disparar direto para a sua base de leads.</p>
                   </div>
                 </li>
               </ul>
               ...
               <div className="bg-[#f25a2f]/10 border border-[#f25a2f]/30 p-4 rounded text-center mt-auto">
                 ...
                 <p className="text-[12px] text-gray-300">Caso você não tenha recebido o link para cadastro no portal, solicite via WhatsApp <strong>+55 33 9819-2119</strong> ou e-mail <strong>comercial@studio57.arq.br</strong>.</p>
               </div>
            </div>
            
            <div className="text-center mt-auto pt-4 border-t border-white/10">
               <p className="text-[12px] text-gray-500 font-bold uppercase tracking-widest">Manual do Corretor • Página 05</p>
            </div>
          </div>
        </FolhaA5Retrato>
        ...
        <FolhaA5Retrato isDark={false}>
          <div className="w-full h-full p-10 flex flex-col relative bg-white">
            ...
            <div className="flex-1 space-y-5">
               <p className="text-[12px] text-gray-600 leading-[1.6] text-justify">
                 O formato Studio otimizado foi desenhado para reduzir o custo de aquisição do investidor e maximizar o valor da locação. Com base no mercado atual do Alto Esplanada e plataformas de temporada, um Studio mobiliado e decorado de alto padrão tem um valor de diária conservador estimado em <strong>R$ 200,00</strong>.
               </p>

               <div className="bg-gray-100 p-4 rounded-xl border border-gray-200">
                 <h3 className="text-[13px] font-extrabold text-gray-900 mb-2 uppercase flex items-center gap-2">
                   <span className="w-2 h-2 rounded-full bg-green-500"></span>
                   Cenário Otimista (70% de Ocupação)
                 </h3>
                 <p className="text-[12px] text-gray-600 mb-1 leading-snug">Ocupação de 21 dias (70% de 30 dias).</p>
               ...
               <div className="bg-gray-100 p-4 rounded-xl border border-gray-200">
                 <h3 className="text-[13px] font-extrabold text-gray-900 mb-2 uppercase flex items-center gap-2">
                   ...
                   Cenário Esperado (57,4% de Ocupação)
                 </h3>
                 <p className="text-[12px] text-gray-600 mb-1 leading-snug">Ocupação de ~17 dias. Média atual da rede hoteleira de GV.</p>
                 <p className="text-[13px] font-black text-yellow-600">Renda Estimada: R$ 3.400,00 /mês</p>
               </div>

               <div className="bg-gray-100 p-4 rounded-xl border border-gray-200">
                 <h3 className="text-[13px] font-extrabold text-gray-900 mb-2 uppercase flex items-center gap-2">
                   <span className="w-2 h-2 rounded-full bg-red-500"></span>
                   Aluguel Tradicional / Pessimista
                 </h3>
                 <p className="text-[12px] text-gray-600 mb-1 leading-snug">Contrato anual fixo para estudantes de medicina/médicos (30% de ocupação temporada).</p>
                 <p className="text-[13px] font-black text-red-600">Renda Estimada: R$ 1.800,00 a R$ 2.200,00 /mês</p>
               </div>

               <div className="bg-[#f25a2f]/10 p-3 rounded-xl border border-[#f25a2f]/30 mt-2">
                 <p className="text-[12px] text-gray-800 leading-[1.4] text-justify">
                   <strong>O Argumento Matador (Payback):</strong> Considerando um ticket médio de R$ 250 mil, no cenário otimista o ativo <strong>se paga 100% em apenas 5 anos</strong> (59,5 meses). A partir disso, é ganho de capital patrimonial e puro lucro (dividendos imobiliários).
                 </p>
               </div>
            </div>
        ...
        <FolhaA5Retrato isDark={false}>
          <div className="w-full h-full p-10 flex flex-col relative bg-white">
            ...
            <div className="flex-1 space-y-6">
               ...
               <div className="bg-[#0a0a0a] p-4 rounded-xl border border-[#f25a2f]/50 mt-4 shadow-xl">
                 <h3 className="text-[13px] font-extrabold text-white mb-2 uppercase flex items-center gap-2">
                   <FontAwesomeIcon icon={faExclamationTriangle} className="text-yellow-500" />
                   A Pior Objeção: "Vou pensar"
                 </h3>
                 <p className="text-[12px] text-gray-300 leading-[1.6] text-justify">
        ...
        ======================================================== */}
        <FolhaA5Retrato isDark={true}>
          <div className="w-full h-full bg-[#0a0a0a] relative flex flex-col items-center justify-center p-10 text-center">
            
            <FontAwesomeIcon icon={faHeadset} className="text-[#f25a2f] text-5xl mb-8 opacity-80" />
            
            <h2 className={`${roboto.className} text-2xl font-light text-white uppercase tracking-[0.15em] leading-none mb-6`}>
              Precisa de Apoio?
            </h2>
            
            <p className="text-gray-400 text-[12px] mb-12 leading-[1.6] max-w-[280px]">
            ...
            <div className="bg-white/5 border border-white/10 p-6 rounded-xl w-full max-w-[320px] mb-16">
              <p className="text-[12px] text-[#f25a2f] font-bold uppercase tracking-widest mb-3">WhatsApp Oficial de Vendas</p>
              <p className="text-xl font-bold text-white tracking-widest">+55 33 9819-2119</p>
            </div>
            ...
            <div className="absolute bottom-8 flex flex-col items-center w-full px-10">
               <img
                  src="https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/empreendimento-anexos/1/IMG_1759092334426.PNG"
                  alt="Studio 57 Logo"
                  className="w-[120px] h-auto object-contain filter brightness-0 invert opacity-40 mb-4"
                />
               <p className="text-[12px] uppercase tracking-[0.4em] text-gray-500 font-bold mb-6">Boas Vendas!</p>
               
               <div className="text-[9px] text-gray-600 text-center space-y-1 w-full border-t border-white/10 pt-4">
                 <p className="uppercase tracking-widest font-bold text-gray-500 mb-1">Studio 57 Incorporações Ltda</p>
