...
import { faBuildingColumns, faRightLeft, faHandHoldingDollar, faCheck } from '@fortawesome/free-solid-svg-icons';
...
export default function PlanoMigracaoPage() {
 ...
 <Image src={LOGO_STUDIO57} alt="Studio 57" width={300} height={100} className="object-contain filter invert opacity-100" // Removi qualquer transparência
 priority
 />
 </div>
 ...
 Plano de <span className="font-bold text-blue-600 block md:inline">Transição</span>
 </h1>
 ...
 <Image src={LOGO_ALFA} alt="Residencial Alfa" width={180} height={80} className="object-contain max-h-full"
 />
 </div>
 ...
 <a href={getWhatsappLink('Financiamento Alfa/Caixa')}
 target="_blank"
 ...
 <div className="bg-black rounded-2xl shadow-2xl overflow-hidden border-2 border-blue-600 flex flex-col transform md:-translate-y-6 md:scale-105 relative z-10">
 {/* Faixa de Destaque */}
 <div className="bg-blue-600 text-white text-center py-2 text-xs font-bold uppercase tracking-widest shadow-md">
 Recomendado pelo Studio 57
 </div>

 <div className="p-6 flex justify-center items-center h-32 bg-blue-600 text-white to-black">
 <Image src={LOGO_BETA} alt="Beta Suítes" width={160} height={80} className="object-contain max-h-full transform hover:scale-105 transition-transform"
 />
 </div>
 <div className="p-8 flex-grow flex flex-col text-white">
 <h3 className="text-2xl font-bold text-white mb-1">Migração Beta</h3>
 <p className="text-blue-600 text-sm font-bold mb-6 uppercase tracking-wide">Investimento Inteligente</p>

 <div className="text-center mb-6 bg-gray-900 rounded-lg p-4 border border-gray-800 relative overflow-hidden">
 <div className="absolute top-0 right-0 w-16 h-16 bg-blue-600 opacity-10 rounded-bl-full"></div>
 <p className="text-gray-400 text-sm mb-1">Seu saldo vale</p>
 <p className="text-5xl font-bold text-white">+20%</p>
 <p className="text-blue-600 text-sm font-bold mt-1">na troca de unidade</p>
 </div>

 <p className="text-gray-300 text-sm italic mb-8 text-center px-4 border-l-2 border-blue-600 pl-4">
 "Transforme R$ 100 mil pagos em <span className="text-white font-bold">R$ 120 mil</span> de crédito imediato."
 </p>

 <ul className="space-y-4 mb-8 flex-grow">
 <li className="flex items-start text-sm text-gray-300">
 <FontAwesomeIcon icon={faRightLeft} className="text-blue-600 mt-1 mr-3 w-4" />
 Migração de <strong>100% do capital</strong>.
 </li>
 <li className="flex items-start text-sm text-gray-300">
 <FontAwesomeIcon icon={faCheck} className="text-blue-600 mt-1 mr-3 w-4" />
 ...
 <a href={getWhatsappLink('Migração Beta com Bônus')}
 target="_blank"
 className="w-full block text-center py-4 rounded-lg bg-blue-600 text-white text-white font-bold shadow-lg shadow-orange-900/50 hover:text-white hover: transition-all transform hover:scale-[1.02] uppercase tracking-wider"
 >
 Quero Migrar Agora
 </a>
 </div>
 ...
 <a href={getWhatsappLink('Recapitalização/Resgate')}
 target="_blank"
