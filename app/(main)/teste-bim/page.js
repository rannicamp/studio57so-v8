...
import BimUploader from '@/components/bim/BimUploader'; import AutodeskViewerAPI from '@/components/bim/AutodeskViewerAPI'; import ProjectList from '@/components/bim/ProjectList'; // Importando a nova lista
...
export default function TesteBimPage() {
 ...
 <span className="bg-blue-600 w-2 h-6 rounded-sm block"></span>
 Gestão de Obras (BIM)
 </h1>
 ...
 <ProjectList onSelectProject={handleSelectModel} activeUrn={currentUrn}
 />
 </div>
 )}
