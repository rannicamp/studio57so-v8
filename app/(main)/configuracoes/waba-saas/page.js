...
export default function WabaSaasConfigPage() {
 ...
 <button className="mt-6 px-6 py-2 bg-gray-100 hover:bg-red-50 hover:text-red-600 text-gray-600 font-semibold rounded-lg transition-colors border shadow-sm"
 onClick={() => {
