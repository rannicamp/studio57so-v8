...
async function fetchFinancialStats(organizacao_id, ano) {
 ...
 const { data, error } = await supabase.rpc('get_rh_financial_evolution', { p_organizacao_id: organizacao_id, p_ano: ano });
...
export default function PayrollChart() {
 ...
 <div className="w-full max-w-[40px] bg-emerald-500 rounded-t-sm transition-all duration-500 group-hover:bg-emerald-600 relative"
