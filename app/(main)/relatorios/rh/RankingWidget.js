...
import { faTrophy, faMedal, faSpinner, faExclamationCircle, faCalendarAlt } from '@fortawesome/free-solid-svg-icons';

export default function RankingWidget({ title, icon, color, data, labelUnit, // ex: "faltas", "atrasos"
 periodoTexto, isLoading, isError }) {
 // Garante array
 ...
 const colorMap = {
 orange: {
 bgIcon: 'bg-blue-600', textIcon: 'text-blue-600',
 bar: 'bg-blue-600', textCount: 'text-blue-600'
 },
 red: {
 ...
 ${idx === 0 ? 'bg-yellow-100 text-yellow-700 ring-2 ring-yellow-200 shadow-sm' : idx === 1 ? 'bg-gray-100 text-gray-600' : idx === 2 ? 'bg-blue-600 text-blue-600' : 'text-gray-400 border border-gray-100'}
 `}>
