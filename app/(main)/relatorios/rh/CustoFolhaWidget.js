...
import { faMoneyBillWave, faSpinner, faCalendarCheck, faExclamationTriangle } from '@fortawesome/free-solid-svg-icons';
...
async function fetchCustoFolha(organizacao_id, mesRef) {
 ...
 const { data, error } = await supabase.rpc('calcular_previsao_folha', { p_organizacao_id: organizacao_id, p_mes_ref: mesRef });
