...
import { faUsers, faBirthdayCake, faUserPlus, faUserMinus, faMoneyBillWave, faSpinner, faCalendarCheck, faClock, faExclamationTriangle
...
export default function RelatorioRhPage() {
 ...
 <input type="month" value={mesRef.slice(0, 7)} onChange={(e) => setMesRef(`${e.target.value}-01`)}
