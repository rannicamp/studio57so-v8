...
export default function RelatorioComercialPage() {
 ...
 <button title="Puxar todo o tempo sem limite"
 ...
 <FontAwesomeIcon icon={faReplyAll} className="text-blue-600 text-xl" />
 </div>
 <div>
 ...
 allowDecimals={false}
 />
 <ReferenceLine y={mediaDiaria} stroke="#8b5cf6" strokeDasharray="4 4" label={{ position: 'insideTopLeft', value: `Média Gerada: ${mediaDiaria} por ${isMensal ? 'mês' : 'dia'}`, fill: '#8b5cf6', fontSize: 11, fontWeight: 500 }} />
 <RechartsTooltip cursor={{ fill: '#f8fafc' }}
 contentStyle={{ borderRadius: '12px', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}
 labelFormatter={(label) => {
 try { return format(parseISO(label), isMensal ? "MMMM 'de' yyyy" : "dd 'de' MMMM", { locale: ptBR }); }
 catch { return label; }
 }}
 ...
 <YAxis dataKey="name" type="category" axisLine={false} tickLine={false} tick={{ fontSize: 11, fill: '#475569', fontWeight: 600 }}
 width={90}
 />
 <RechartsTooltip cursor={{ fill: '#f8fafc' }}
 contentStyle={{ borderRadius: '12px', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}
