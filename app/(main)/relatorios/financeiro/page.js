...
export default function RelatorioFinanceiroPage() {
 ...
 const [visaoGeral, setVisaoGeral] = useState('dashboard'); // Abas
 ...
 <button
 className={`flex-1 flex justify-center items-center gap-2 py-2 px-4 rounded-md font-medium text-sm transition-colors ${visaoGeral === 'dre' ? 'bg-indigo-50 text-indigo-700 shadow-sm border border-indigo-100' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'}`}
 onClick={() => setVisaoGeral('dre')}
 >
 Demonstração (DRE)
 </button>
 <button
 className={`flex-1 flex justify-center items-center gap-2 py-2 px-4 rounded-md font-medium text-sm transition-colors ${visaoGeral === 'contratos' ? 'bg-blue-600 text-blue-600 shadow-sm border border-blue-600' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'}`}
