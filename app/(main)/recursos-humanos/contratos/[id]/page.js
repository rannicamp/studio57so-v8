 ...
 *,
 ...
 contrato.status === 'Ativo' ? 'bg-green-50 text-green-700 border-green-200' : contrato.status === 'Encerrado' ? 'bg-gray-100 text-gray-600 border-gray-200' :
 'bg-yellow-50 text-yellow-700 border-yellow-200'
 }`}>
 <div className={`w-2 h-2 rounded-full ${
 contrato.status === 'Ativo' ? 'bg-green-500' : contrato.status === 'Encerrado' ? 'bg-gray-500' : 'bg-yellow-500'
 }`}></div>
 {contrato.status}
 </span>
 </div>
