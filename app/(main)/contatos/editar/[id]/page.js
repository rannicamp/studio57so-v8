...
export default function EditarContatoPage() {
 ...
 enabled: !!id && !!organizacaoId, retry: false,
 });
 ...
 return (
 <div className="p-4">
 <ContatoForm contactToEdit={initialData} organizacaoId={organizacaoId} onSaveSuccess={handleSaveSuccess} onClose={handleSaveSuccess} />
 </div>
 );
}