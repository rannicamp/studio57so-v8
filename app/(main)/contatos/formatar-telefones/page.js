...
export default function PadronizacaoPage() {
 ...
 let countryCode = '+55';
 if (finalNumber.length === 11 && finalNumber.startsWith('1')) {} else if (finalNumber.length === 10 || finalNumber.length === 11) finalNumber = `55${finalNumber}`;
