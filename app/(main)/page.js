...
// Posição inicial dos cards na grade
const initialLayout = [
...
export default function DashboardPage() {
    ...
    // Efeito para carregar o layout salvo do navegador
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        loadDashboardData();
    }, [user, userData, authLoading, fetchEmployeeAndUserData, fetchMonthlyHoursSummary, fetchDollarRate]);
        ...
        <div className="flex flex-col min-h-screen bg-gray-100">
            ...
            <main className="flex-1 p-6 md:p-8 lg:p-10">
                ...
                >
                    ...
                    {/* KPIs de Ponto Compactos - FORA DO CONDICIONAL */}
                    {/* Card para Dias Trabalhados */}
                    <div key="days-card" className="panel-card bg-white p-4 rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full flex flex-col items-center text-center">
                    ...
                    <div key="hours-card" className="panel-card bg-white p-4 rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full flex flex-col items-center text-center">
                    ...
                    <div key="overtime-card" className="panel-card bg-white p-4 rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full flex flex-col items-center text-center">
