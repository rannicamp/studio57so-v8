...
import { createNewContrato } from './actions'; // <-- AÇÃO IMPORTADA AQUI

// ... (as funções fetchFilterData e fetchContratos permanecem exatamente as mesmas)
...
                <h1 className="text-3xl font-bold text-gray-900">Gestão de Contratos</h1>
                {/* ================================================================================= */}
                {/* INÍCIO DA ALTERAÇÃO                                                               */}
                {/* O PORQUÊ: Trocamos o Link por um formulário que chama a nossa nova Server Action. */}
                {/* Isso cria o contrato no servidor e nos redireciona para a página correta.         */}
                {/* ================================================================================= */}
