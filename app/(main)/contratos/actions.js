...
export async function updateContratoStatus(contratoId, newStatus) {
 ...
 if ((tipoDoc === 'CONTRATO' || tipoDoc.includes('COMPRA E VENDA')) && !tipoDoc.includes('TERMO') && !tipoDoc.includes('INTERESSE')) {
 ...
 revalidatePath('/empreendimentos'); return { success: true };
}