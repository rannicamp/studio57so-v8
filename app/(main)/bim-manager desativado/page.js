...
export default function BimManagerPage() {
 const [selectedContext, setSelectedContext] = useState(null); const [activeUrn, setActiveUrn] = useState(null); useEffect(() => {
 ...
 <BimSidebar onSelectContext={handleContextSelect} onFileSelect={handleFileSelect}
 selectedContext={selectedContext} activeUrn={activeUrn}
 />
 ...
 <button onClick={() => setActiveUrn(null)}
 ...
 <BimContent context={selectedContext} onFileSelect={handleFileSelect}
