...
export async function POST(request) {
 ...
 const isBrazil = reg.country_code === '+55' || (!reg.country_code && (rawPhone.length === 10 || rawPhone.length === 11));
 ...
 // ... (Se quiser manter a busca por nome/doc, podemos adicionar aqui, // mas o foco agora foi resolver o telefone) ...
