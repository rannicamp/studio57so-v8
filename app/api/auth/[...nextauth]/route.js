...
// Usamos a chave de serviço (ou a anon se a service não estiver disponível) // para garantir que conseguimos gravar o token independente de permissão de tela.
...
export const authOptions = {
 ...
 // ou precisamos garantir que o email bata. // NOTA: Para funcionar perfeito, o token.sub deve ser o UUID do usuário no Supabase.
