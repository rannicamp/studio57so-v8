...
const MODEL_NAME = "gemini-2.0-flash"; export async function POST(request) {
 ...
 .eq('organizacao_id', usuarioOrganizacaoId) .single();
 ...
 promptParts.push({ inlineData: { mimeType: fileBlob.type, data: buffer.toString('base64') } });
 ...
 analise_ia: dadosIa.analise_textual, caminhos_arquivos: filesToAudit,
 ...
 return NextResponse.json({ success: true, status: statusAuditoria, analise: dadosIa });
