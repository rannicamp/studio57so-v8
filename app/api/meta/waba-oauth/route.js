    ...
    try {
        ...
        if (!wabaEncontrada || !phoneEncontrado) {
            return NextResponse.json({ 
                error: 'Sua conta Facebook foi vinculada, mas não encontramos o seu Número Oficial de WhatsApp. Certifique-se de ter concluído o processo no pop-up.',
                debug_info: bmData
            }, { status: 404 });
        }
        ...
        const payloadWhatsApp = {
            ...
            whatsapp_permanent_token: bestToken, 
