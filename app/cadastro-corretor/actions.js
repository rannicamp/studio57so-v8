...
const supabaseAdmin = createAdminClient()
 ...
 const { nome, email, password, confirmPassword, creci, cpf, termId, organizacaoIdForm,
...
try {
 ...
 nome: nome,
 cpf: cpf,
 creci: creci, // Dados Profissionais Implícitos
 tipo_contato: 'Corretor', cargo: 'Corretor de Imóveis', // Adicionado para constar na ficha
 ...
 city: city,
 state: state,
 organizacao_id: organizacaoFinal, criado_por_usuario_id: newUserId,
 }).select('id').single();
 ...
 console.error('[ACTION] CATCH:', error); if (newUserId) {
