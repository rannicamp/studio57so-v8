...
import { faSpinner, faCheckCircle, faBuildingUser,
 faFileContract,
 faXmark,
...
function CadastroCorretorForm() {
 ...
 neighborhood: '', city: '', state: '', acceptedTerms: false, termId: prev.termId // Mantém só o ID do termo
 }));
 ...
 organizacaoIdForm: ORGANIZACAO_ID, ...securityData
 }
 ...
 <button onClick={() => { setFormData(prev => ({ ...prev, acceptedTerms: true })); setShowModal(false); toast.success("Termos aceitos!"); }} disabled={!termContent}
