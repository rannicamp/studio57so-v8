...
export default async function CadastroClienteDinamicoPage({ params }) {
 ...
 <img
 src={organizacao.logo_url || "https://vhuvnutzklhskkwbpxdz.supabase.co/storage/v1/object/public/marca/public/STUDIO%2057%20PRETO%20-%20RETANGULAR.PNG"} alt={`Logo de ${organizacao.nome}`}
