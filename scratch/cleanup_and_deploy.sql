-- Remove as assinaturas sobrecarregadas antigas para resolver o erro PGRST203
DROP FUNCTION IF EXISTS public.fn_relatorio_comercial(p_organizacao_id integer, p_data_inicio date, p_data_fim date);
DROP FUNCTION IF EXISTS public.fn_relatorio_comercial(p_data_inicio text, p_data_fim text, p_organizacao_id integer);

-- Recria a funcao com a assinatura unica e definitiva com a correcao de fuso horario
