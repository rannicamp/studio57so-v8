export default function TutorialNotificacoes() {
 ...
 <br/><br/>
 Selecione as pessoas desejadas e aguarde o Salvamento Mágico aparecer. <strong>Se você pular essa etapa e não marcar ninguém, o sistema não saberá para quem apitar, e a notificação se perderá no vácuo!</strong>
 </p>
 </div>
 </div>
 </div>
