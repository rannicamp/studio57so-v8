...
export default function TutoriaisManager() {
 ...
 className={`text-left p-4 border-b last:border-0 transition-all flex items-center justify-between border-l-4 ${isSelected ? 'bg-rose-50 border-l-rose-500' : 'bg-white hover:bg-gray-50 border-l-transparent text-gray-600'}`}
 >
 ...
 {/* Title Bar do Post */}
 <div className="p-6 md:p-8 border-b bg-blue-600 text-white to-white flex items-start gap-4">
 ...
 {/* Corpo do Texto */}
 <div className="p-6 md:p-8 flex-1 prose prose-rose max-w-none prose-h3:text-gray-800 prose-h3:text-xl prose-p:text-gray-600 prose-p:leading-relaxed prose-li:text-gray-600 prose-strong:text-gray-800">
 {ativo.componente}
 </div>
 </div>
 </div>
