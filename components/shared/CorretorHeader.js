...
import { faUser, faSignOutAlt, faCog, faChevronDown,
 faBars
...
export default function CorretorHeader({ toggleSidebar }) {
 ...
 <Link href="/portal-perfil" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600"
