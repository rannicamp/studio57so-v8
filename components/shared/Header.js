...
import { faChevronLeft, faChevronRight, faHome, faUserCircle, faBuilding, faCog, faInbox, faUser, faChevronDown, faBars } from '@fortawesome/free-solid-svg-icons';
...
import NotificationBell from '@/components/notificacao/NotificationBell'; import FeedbackModal from '@/components/feedback/FeedbackModal';
...
export default function Header({ headerPositionClass, toggleSidebar }) {
 ...
 <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="flex items-center gap-1 md:gap-2 cursor-pointer hover:bg-gray-50 p-1 rounded-full transition-colors border border-transparent hover:border-gray-200 focus:outline-none"
 >
 {userPhoto ? (
