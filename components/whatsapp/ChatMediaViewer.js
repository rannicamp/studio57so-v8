...
export default function ChatMediaViewer({ isOpen, onClose, mediaUrl, mediaType, fileName }) {
 ...
 return (
 <div
 className="fixed inset-0 bg-black/90 flex items-center justify-center z-[99999] p-4 backdrop-blur-sm transition-all duration-300"
 ...
 <div className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center z-50 bg-blue-600 from-black/60 to-transparent">
