...
export default function FilePreviewModal({ isOpen, onClose, file, onSend }) {
 ...
 {/* Background escuro */}
 <div className="fixed inset-0 bg-black/70 backdrop-blur-sm transition-all" aria-hidden="true" />

 <div className="fixed inset-0 flex items-center justify-center p-4">
 <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-[#efeae2] shadow-2xl transition-all flex flex-col max-h-[90vh] animate-fade-in-up">
