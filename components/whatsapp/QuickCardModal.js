...
export default function QuickCardModal({ isOpen, onClose, conversation, onSuccess }) {
 ...
 <select className="w-full border rounded-lg p-2.5 text-sm focus:ring-[#00a884] focus:border-[#00a884] bg-white outline-none appearance-none"
 ...
 <div className="relative">
 <select className="w-full border rounded-lg p-2.5 text-sm focus:ring-[#00a884] focus:border-[#00a884] bg-white outline-none appearance-none disabled:bg-gray-100"
 ...
 <button onClick={handleSave} disabled={saving || !selectedColumn}
