...
function MapController({ coords }) {
 ...
 const timeoutId = setTimeout(() => { // Verifica se o mapa ainda está renderizado para evitar erro de '_leaflet_pos'
...
export default function LocationMap({ position, onPositionChange }) {
 ...
 return (
 <MapContainer center={displayPosition} zoom={15} style={{ height: '100%', width: '100%' }}
