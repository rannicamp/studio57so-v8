    ...
    useEffect(() => {
        if (isOpen) {
            if (initialData) {
                ...
                setFormData({ to: '', cc: '', bcc: '', subject: '', body: '', replyToMessageId: null, attachments: [] });
            }
            setSuggestions([]);
        }
    }, [isOpen, initialData]);
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-grow overflow-hidden">
                        ...
                        <div className="grid gap-4 relative">
                            <div className="flex items-center gap-2 border-b border-gray-100 pb-2 relative">
                                ...
                                <div className="flex-grow relative">
                                    ...
                                    />
                                    {isSearching && (
                                        <div className="absolute right-0 top-0 bottom-0 flex items-center pr-2 text-gray-400">
                                    ...
                                    <div className="absolute top-full left-16 right-0 bg-white border border-gray-200 rounded-lg shadow-xl z-50 mt-1 max-h-60 overflow-y-auto custom-scrollbar">
                                        {suggestions.map((item, idx) => (
                                            <div 
                                                ...
                                                className="px-4 py-3 hover:bg-blue-50 cursor-pointer border-b border-gray-50 last:border-0 flex items-center gap-3 transition-colors"
                                            >
                                                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 text-xs font-bold shrink-0">
                                                    <FontAwesomeIcon icon={item.isCompany ? faBuilding : faUser} />
                                                </div>
                    ...
                    <div className="px-6 py-4 border-t bg-gray-50 rounded-b-xl flex justify-between items-center shrink-0">
                        <div className="flex gap-4">
                            ...
                            <button type="button" onClick={handleAttachmentClick} className="text-gray-500 hover:text-blue-600 text-sm flex items-center gap-2 px-2 py-1 rounded hover:bg-gray-100">
                                <FontAwesomeIcon icon={faPaperclip} /> <span className="hidden sm:inline">Anexar</span>
                            </button>
                            <button type="button" onClick={() => setFormData({...formData, body: '', attachments: [], to: '', subject: ''})} className="text-gray-500 hover:text-red-500 text-sm px-2 py-1 rounded hover:bg-gray-100">
