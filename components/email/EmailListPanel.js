                            ...
                            <div className="flex flex-col items-center justify-center h-full p-8 text-center animate-in fade-in duration-300">
                                <div className="bg-gray-50 border border-gray-100 rounded-2xl p-8 max-w-sm w-full mx-auto shadow-sm flex flex-col items-center">
                                    <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-4 text-blue-400">
                                        <FontAwesomeIcon icon={filterStatus === 'unread' ? faEnvelopeOpen : faBoxOpen} className="text-3xl" />
                                    </div>
                                    <h3 className="text-lg font-bold text-gray-800 mb-1">Tudo limpo por aqui!</h3>
                                    <p className="text-sm text-gray-500">{searchTerm ? `Nenhum resultado encontrado para "${searchTerm}".` : 'Não encontramos e-mails nesta seção.'}</p>
                                </div>
                            </div>
                        )
                            : (
