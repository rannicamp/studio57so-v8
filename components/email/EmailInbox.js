...
function EmailInboxContent({ onChangeTab, canViewWhatsapp }) {
 ...
 <div className={`
 ${hasSelection ? 'flex' : 'hidden md:flex'} ${showEmailReadingPane ? 'hidden lg:flex lg:w-[350px] border-r shrink-0' : 'flex-grow'} flex-col bg-[#efeae2] h-full overflow-hidden relative min-h-0 shadow-xl z-20
 `}>
 {selectedEmailFolder ? (
 <EmailListPanel
