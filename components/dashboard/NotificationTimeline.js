...
import { faHome, faFileSignature, faBell, faMoneyBillWave, faCheckCircle, faClock, faExclamationCircle, faHistory, faSpinner, faSearch, faTimes
...
const formatNotificationMessage = (texto) => {
 ...
 // Captura números crus com ponto e duas casas decimais cercados por espaços ou como última palavra // converte para moeda R$ 1.234,56
...
export default function NotificationTimeline() {
 ...
 <input type="text" placeholder="Pesquisar log..." value={searchTerm}
