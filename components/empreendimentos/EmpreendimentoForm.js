...
export default function EmpreendimentoForm({ empreendimento, corporateEntities = [], proprietariaOptions = [] }) {
 ...
 className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all text-sm font-medium text-gray-900"
 ...
 <button type="button" onClick={() => router.back()} className="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-50 text-sm font-bold transition-colors">
 Cancelar
 </button>

 <button type="submit" disabled={saveStatus === 'saving'} className="bg-blue-600 text-white text-sm font-bold px-6 py-2 rounded-md hover:bg-blue-700 disabled:bg-blue-400 flex items-center gap-2 transition-colors shadow-sm">
