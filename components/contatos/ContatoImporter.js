...
export default function ContatoImporter({ isOpen, onClose, onImportComplete }) {
    ...
    return (
        <UppyFileImporter
            ...
            note="Selecione ou arraste o arquivo CSV com a lista de contatos"
        >
            ...
            <div className="flex justify-end space-x-3 mt-6 border-t pt-4">
                ...
                <button onClick={processAndImport} disabled={isProcessing || headers.length === 0} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:bg-blue-300 flex items-center gap-2 transition-colors">
