...
import { faUser, faBuilding, faEnvelope, faPhone, faMapMarkerAlt, faCalendarAlt, faEdit, faSpinner, faPlus, faTrash, faIdCard, faBriefcase, faMoneyBillWave
...
const EditableArrayField = ({ items, onUpdate, onAdd, onRemove, type, contactId, queryClient }) => {
 ...
 const { error } = await supabase.from(type).insert({ contato_id: contactId, [type === 'emails' ? 'email' : 'telefone']: payload.value,
