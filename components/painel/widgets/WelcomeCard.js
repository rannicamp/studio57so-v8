...
export default function WelcomeCard({ user }) {
 ...
 const [fraseDoDia, setFraseDoDia] = useState(frasesDeImpacto[0]); const greeting = getGreeting();
 ...
 const dateString = currentDate.toLocaleDateString('pt-BR', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' });
