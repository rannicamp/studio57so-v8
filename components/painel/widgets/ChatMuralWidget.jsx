...
export default function ChatMuralWidget() {
    ...
    return (
        <div className="bg-white shadow-sm border border-gray-200 rounded-2xl overflow-hidden flex flex-col mt-6">
            <div className="p-5 md:p-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-gray-50 to-white">
                <div className="flex items-center gap-3">
                    ...
                    <form onSubmit={handleCreatePost} className="max-w-3xl mx-auto flex flex-col gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div className="flex justify-between items-center mt-2 gap-3">
                            <button 
                                ...
                                className="px-5 py-3.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-xl font-bold shadow-sm text-[13px] hover:shadow-md hover:from-purple-600 hover:to-indigo-600 disabled:opacity-50 transition-all flex items-center justify-center gap-2 group"
                            >
