...
export default function PanelConciliacaoOFX({ contaId, isCartaoCredito, arquivosOfxIds = [], mesSelecionado, onClosePanel }) {
 ...
 }} disabled={desagruparBorderoMutation.isPending} className="text-blue-600 hover:bg-blue-600 rounded p-1 text-[10px] font-bold ml-1" title="Desfazer agrupamento em Borderô">
 DESFAZER
 </button>
 )}
 ...
 <input type="text" placeholder="Buscar descrições ou valores..." value={searchTerm}
