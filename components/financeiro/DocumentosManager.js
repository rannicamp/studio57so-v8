...
import { faFileImage, faFileAlt, faDownload, faEye, faSearch, faThLarge, faList, faSpinner, faFilePdf } from '@fortawesome/free-solid-svg-icons';
...
const FileThumbnail = ({ caminhoArquivo, nomeArquivo }) => {
 ...
 if (isImage) {
 return (
 <img src={publicUrl} alt={nomeArquivo}
...
export default function DocumentosManager({ filters }) {
 ...
 const { data: docsData, isLoading } = useDocumentos({ filters, page, itemsPerPage });
