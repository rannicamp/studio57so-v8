...
import { faPlus, faEdit, faTrash, faUndo, faTimes, faCheckCircle, faCalendarCheck } from '@fortawesome/free-solid-svg-icons';
...
export default function ConciliacaoItem({
 ...
 <FontAwesomeIcon icon={faCalendarCheck} className="text-blue-600" title="Data da Transação (Cartão)" />
 )}
 </div>
