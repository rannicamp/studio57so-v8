...
export default function ConciliacaoFooter({ calculadora, matchesCount, onProceedMatch, onCancelSelection, onConfirmAll,
 isProcessing }) {
 ...
 {matchesCount > 0 && !calculadora && (
 <button onClick={onConfirmAll} disabled={isProcessing} className="bg-blue-800 text-white font-bold px-8 py-3 rounded-lg text-lg hover:bg-blue-900 disabled:bg-gray-400 flex items-center gap-3 shadow-lg transform transition hover:-translate-y-1"
 >
