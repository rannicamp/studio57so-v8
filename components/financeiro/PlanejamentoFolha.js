...
import { faSpinner, faExclamationTriangle, faFileInvoiceDollar, faSearch, faUsers, faInfoCircle, faClock, faPlusCircle, faFilter, faEraser, faCalendarAlt
...
export default function PlanejamentoFolha({ filters, setFilters }) {
 ...
 queryKey: ['folhaAuditoria', user?.organizacao_id, filters?.startDate, filters?.endDate], queryFn: () => fetchAuditoriaFolha(user?.organizacao_id, filters),
