...
export default function FinanceiroStats({ data, isLoading }) {
 ...
 <div className={`bg-white p-4 rounded-lg shadow-sm border-l-4 hover:shadow-md transition-shadow ${stats.saldoRealizado >= 0 ? 'border-gray-600' : 'border-blue-600'}`}>
 <div className="flex justify-between items-start">
 <div>
 <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Caixa (Realizado)</p>
 <h3 className={`text-2xl font-bold ${stats.saldoRealizado >= 0 ? 'text-gray-700' : 'text-blue-600'}`}>
