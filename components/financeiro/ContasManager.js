...
const TYPE_COLORS = {
 ...
 'Cartão de Crédito': 'text-blue-600 bg-blue-600',
...
export default function ContasManager({ initialContas, onUpdate, empresas, onVerExtrato }) {
 ...
 {/* Header */}
 <div className="p-4 border-b bg-blue-600 text-white to-white flex items-center gap-3">
 ...
 <>
 <p className="font-bold text-sm text-blue-600">{formatCurrency(limite)}</p>
 ...
 {totalLimite > 0 ? (
 <>
 <p className="font-black text-sm text-blue-600">{formatCurrency(totalLimite)}</p>
