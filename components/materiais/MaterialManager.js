...
export default function MaterialManager({ initialMaterials }) {
 ...
 return (
 <>
 <MaterialFormModal isOpen={isFormModalOpen} onClose={() => setIsFormModalOpen(false)} onSave={handleSaveMaterial} material={editingMaterial}
 ...
 material.classificacao === 'Equipamento' ? 'bg-blue-600 text-blue-600' : 'bg-teal-100 text-teal-800'
 }`}>
