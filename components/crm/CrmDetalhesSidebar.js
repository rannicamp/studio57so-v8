...
export default function CrmDetalhesSidebar({ open, onClose, funilEntry, onAddActivity, onEditActivity, onContactUpdate, refreshKey }) {
 ...
 <header className="sticky top-0 z-10 bg-blue-600 px-6 py-4 flex justify-between items-center text-white flex-shrink-0">
 <h2 className="text-base font-bold truncate">{contato.nome || contato.razao_social}</h2>
