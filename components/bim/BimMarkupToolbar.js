...
import { faPen, faArrowRight, faFont, faSquare, faCircle, faUndo, faTrash, faSave, faTimes, faArrowsAlt
} from '@fortawesome/free-solid-svg-icons';

export default function BimMarkupToolbar({ activeTool, setMarkupTool, onUndo, onClear, onSave, onCancel }) {
 return (
 ...
 <button onClick={() => setMarkupTool('freehand')}
 ...
 <button onClick={() => setMarkupTool('arrow')}
 ...
 <button onClick={() => setMarkupTool('rectangle')}
 ...
 <button onClick={() => setMarkupTool('circle')}
 ...
 <button onClick={() => setMarkupTool('text')}
