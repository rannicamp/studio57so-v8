...
import { faFolder, faFolderOpen, faChevronRight, faChevronDown, faSearch, faGhost, faSpinner, faPlus, faRecycle, faSave, faCube, faTimesCircle
...
export default function BimSidebar({ onSelectContext, onFileSelect, onToggleModel, selectedModels = [], selectedContext, activeUrn, onLoadSet, onClearAll }) {
 ...
 <BimFileItem key={f.id} file={f} isActive={activeUrn === f.urn_autodesk.replace(/^urn:/, '')}
