...
export default function BimContent({ children, activeFile }) {
 ...
 // Se houver um arquivo ativo (selecionado no Sidebar), // o BimContent apenas renderiza o que está dentro dele (o Viewer)
 if (activeFile) {
 return (
 ...
 Elo 57 <span className="text-blue-600">BIM Manager</span>
 </h2>
