...
export default function ProjectList({ onSelectProject, activeUrn }) {
 ...
 ${isActive ? 'bg-blue-50 border-blue-500 ring-1 ring-blue-500 shadow-sm' : 'bg-white border-gray-200 hover:border-blue-600 hover:shadow-md'
 }
 `}
 >
 ...
 ${isActive ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-500 group-hover:bg-blue-600 group-hover:text-blue-600'}
 `}>
