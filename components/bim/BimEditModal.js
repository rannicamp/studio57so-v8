...
export default function BimEditModal({ isOpen, onClose, fileToEdit, onSuccess }) {
 ...
 <select value={selectedEmpresa} onChange={(e) => {setSelectedEmpresa(e.target.value); setSelectedObra('');}} className="w-full border border-gray-300 rounded-lg p-2 text-sm bg-white focus:ring-2 focus:ring-blue-100 outline-none"
 disabled={isSaving}
 >
 ...
 <select value={selectedObra} onChange={(e) => setSelectedObra(e.target.value)} disabled={!selectedEmpresa || isSaving} className="w-full border border-gray-300 rounded-lg p-2 text-sm disabled:bg-gray-100 bg-white focus:ring-2 focus:ring-blue-100 outline-none"
 >
 <option value="">Selecione...</option>
 ...
 <select value={selectedDisciplina} onChange={(e) => setSelectedDisciplina(e.target.value)} disabled={isSaving}
