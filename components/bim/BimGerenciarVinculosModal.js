...
export default function BimGerenciarVinculosModal({
 ...
 // Pra evitar complexidade extrema de sub-ramos matemáticos, a Subcomposição será pendurada // no PRIMEIRO mapeamento válido do Pai. Se ele foi atrelado à Parede, penduramos lá.
