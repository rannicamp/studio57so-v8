...
export default function OrcamentoItemModal({ isOpen, onClose, onSave, etapas, itemToEdit, organizacaoId, empreendimentoId }) {
 ...
 // Se for banco próprio, FILTRA pela organização. // SINAPI é público, então traz tudo.
 ...
 className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all"
 />
 {isSearching && (
 ...
 type="button"
 onClick={onClose}
 className="bg-white border border-gray-300 text-gray-700 px-6 py-2 rounded-md hover:bg-gray-50 text-sm font-bold transition-colors"
 >
 Cancelar
 </button>
 <button
 type="submit"
 disabled={loading}
 className="bg-blue-600 text-white text-sm font-bold px-6 py-2 rounded-md hover:bg-blue-700 disabled:opacity-50 transition-colors flex items-center gap-2 shadow-sm"
 >
