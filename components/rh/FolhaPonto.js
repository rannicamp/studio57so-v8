...
export default function FolhaPonto({ employeeId, month, canEdit }) {
 ...
 let pathStr = employeeData.foto_url;
 const patterns = [
 ...
 const { data: signData } = await supabase.storage.from(BUCKET).createSignedUrl(pathStr, 3600);
 employeeData.foto_url = signData?.signedUrl || null;
 }
 }
 ...
 return (
 <div className="printable-area s57-print-area space-y-4">
 <LancarValeModal
