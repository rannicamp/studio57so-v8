...
export default function ContratoGeral({ contrato, onUpdate }) {
 ...
 if (onUpdate) onUpdate(); } catch (error) {
 console.error(error);
 ...
 <input type="text" className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-semibold"
 ...
 <select className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
 ...
 <input type="date" className="w-full border border-gray-300 rounded-lg p-2.5 pl-10 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
