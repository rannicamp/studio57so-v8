 ...
 *,
 ...
 // Tenta baixar no navegador const a = document.createElement('a');
 ...
 <GerenciadorAnexosGlobal anexos={anexos.map(anexo => ({ ...anexo, public_url: supabase.storage.from('contratos-documentos').getPublicUrl(anexo.caminho_arquivo).data.publicUrl }))}
 ...
 {anexoParaEditar && (
 <ModalEditarAnexo anexo={anexoParaEditar}
