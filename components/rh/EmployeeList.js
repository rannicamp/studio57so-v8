...
const EmployeeTable = ({ employees, onDismissClick, onEditClick, requestSort, sortConfig, isCandidateList = false }) => {
 ...
 className="bg-green-600 hover:bg-green-700 text-white text-xs font-bold px-3 py-1.5 rounded-md shadow-sm inline-flex items-center gap-1 transition-colors"
 ...
 <div className="flex items-center justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
 <Link href={`/funcionarios/visualizar/${employee.id}`} title="Ver Ficha Completa" className="text-blue-500 hover:text-blue-700 transition-colors">
 ...
 <button onClick={() => onDismissClick(employee)} className="text-gray-500 hover:text-red-700 transition-colors" title="Demitir">
