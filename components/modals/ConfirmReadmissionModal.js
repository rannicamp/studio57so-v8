...
export default function ConfirmReadmissionModal({ isOpen, onClose, onConfirm, funcionarioExistente }) {
 ...
 <button onClick={onClose} className="px-6 py-2 rounded-lg text-gray-800 bg-gray-200 hover:bg-gray-300 font-semibold transition-colors duration-200"
 >
 Cancelar
 </button>
 <button onClick={onConfirm} className="px-6 py-2 rounded-lg text-white bg-blue-600 hover:bg-blue-700 font-semibold transition-colors duration-200 flex items-center gap-2"
 >
