...
import {
 faTimes, faPen, faCalendarAlt, faUser, faBuilding, faClipboardList,
...
export default function PedidoDetalhesSidebar({
 ...
 <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide border ${pedido.status === 'Entregue' ? 'bg-green-100 text-green-800 border-green-200' :
