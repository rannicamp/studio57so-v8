...
export default function FeriadoManager({ initialFeriados }) {
    ...
    const [newFeriado, setNewFeriado] = useState({ data_feriado: '', descricao: '' });
    ...
    const handleAddFeriado = async () => {
        ...
        toast.promise(promise, {
            ...
            success: (response) => {
                ...
                setNewFeriado({ data_feriado: '', descricao: '' });
                        ...
                        {feriados.map(feriado => (
                            <tr key={feriado.id}>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    ...
                                    {new Date(feriado.data_feriado + 'T00:00:00Z').toLocaleDateString('pt-BR', { timeZone: 'UTC' })}
                                </td>
