...
export default function ActivityBimLink({ count }) {
 ...
 ${isMultiple ? 'bg-indigo-50 border-indigo-200 text-indigo-800' // Estilo Roxo para Múltiplos
 ...
 Criando atividade vinculada a <span className="text-lg mx-1">{count}</span> {isMultiple ? 'elementos selecionados' : 'elemento selecionado'}.
 </p>
 </div>
 </div>
