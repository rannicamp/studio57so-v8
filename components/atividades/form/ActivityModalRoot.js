...
export default function ActivityModalRoot({
 ...
 recorrencia_fim: formData.recorrencia_fim || null,
 ...
 <div className="flex items-center justify-between p-6 border-b sticky top-0 bg-white rounded-t-lg z-20 shrink-0">
 <div>
 ...
 <button onClick={onClose} type="button" className="text-gray-400 hover:text-gray-600 p-2 rounded-full transition-colors">
 ...
 <div className="p-6 border-t bg-gray-50 rounded-b-lg flex justify-between items-center shrink-0">
 <div>
 {isEditing && (
