...
export default function ActivityContextFields({ formData, setFormData, options, // { empresas, empreendimentos } vindos do Root
 organizacaoId }) {
 ...
 <select name="empresa_id" value={formData.empresa_id || ''} onChange={handleChange} className="w-full p-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
 >
 ...
 <select name="empreendimento_id" value={formData.empreendimento_id || ''} onChange={handleChange} disabled={!formData.empresa_id}
 ...
 <select name="etapa_id" value={formData.etapa_id || ''} onChange={handleChange} disabled={!formData.empreendimento_id}
 className="w-full p-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white disabled:bg-gray-100 disabled:text-gray-400"
 >
 ...
 <div key={sub.id} onMouseDown={() => handleSelectSubetapa(sub)} // onMouseDown executa antes do onBlur
 ...
 <div onMouseDown={handleCreateSubetapa}
