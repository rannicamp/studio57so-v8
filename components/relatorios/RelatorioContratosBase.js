    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 className="text-2xl font-extrabold text-gray-800 tracking-tight flex items-center gap-2">
                        <FontAwesomeIcon icon={faFileContract} className="text-orange-500" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white border-l-4 border-orange-500 rounded-xl shadow-sm p-6">
                    <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Saldo Devedor / A Receber</div>
                    <div className="text-3xl font-black text-orange-600">{formatCurrency(totalAReceber)}</div>
                    <div className="text-xs text-orange-500 font-medium mt-1">Volume financeiro pendente</div>
                </div>
            </div>
