...
export default function FinanceiroDashboard() {
 ...
 <KpiCard titulo="Resultado" valor={kpis?.saldo} icon={faWallet} corIcone={kpis?.saldo >= 0 ? "text-blue-500" : "text-blue-600"} bgIcone={kpis?.saldo >= 0 ? "bg-blue-50" : "bg-blue-600"} destaque />
 </div>
 ...
 <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 min-h-[400px]">
 <h3 className="text-lg font-bold text-gray-800 mb-6 flex items-center gap-2">
 <div className="w-1 h-6 bg-blue-600 rounded-full"></div> Top Despesas
 </h3>
