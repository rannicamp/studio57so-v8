...
export default function AdsManager() {
  ...
  // 3. LOGICA DE FILTRAGEM CENTRALIZADA: Filtramos os anúncios localmente para sincronizar com os KPIs
  ...
  return (
    <div className="space-y-6">
      ...
      {!accountsData.selected_account_id ? (
        ...
        <>
          <KpiAnuncios data={filteredAds} isLoading={isLoadingAds} />
