            ...
            <tr key={ad.id} className="hover:bg-gray-50 transition-colors">
              <td className="px-6 py-4">
                <div className="flex items-center gap-3">
                  <div className="relative flex-shrink-0 h-12 w-12 rounded-lg bg-gray-100 border overflow-hidden flex items-center justify-center">
                    {ad.thumbnail_url ? (
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-bold text-gray-800 line-clamp-1" title={ad.name}>
                      {ad.name}
                    </span>
