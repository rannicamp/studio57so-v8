...
export default function TabelaVendasGeral({ initialProdutos = [], uiStateKey = null }) {
 ...
 <FontAwesomeIcon icon={faFilter} className="text-3xl opacity-80" />
 </div>
 <h3 className="text-lg font-bold text-gray-800 mb-1">Tabela Vazia</h3>
 <p className="text-sm text-gray-500 px-4">Nenhuma unidade corresponde aos filtros selecionados atualmente.</p>
 </div>
 </div>
 </td>
 </tr>
