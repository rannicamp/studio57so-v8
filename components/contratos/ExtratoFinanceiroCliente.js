                        ...
                        <thead className="bg-gray-50/80">
                            <tr>
                                ...
                                {indiceEscolhido && <>
                                    ...
                                    <th className="px-4 py-3 text-right font-extrabold text-[10px] text-orange-500 uppercase tracking-widest">+ por Parcela</th>
                                </>}
                                ...
                                return (
                                    <tr key={l.id} className={`hover:bg-blue-50/30 transition-colors ${temEvento ? 'bg-amber-50 border-l-2 border-amber-500' : temSplit ? 'border-l-2 border-amber-100' : ''}`}>
                                        ...
                                        {indiceEscolhido && <>
                                            ...
                                            <td className="px-4 py-3 text-right whitespace-nowrap">
                                                {temSplit
                                                    ? <span className="font-bold text-orange-600 text-xs">+ {formatCurrency(l.correcao_split)}</span>
                                                    : <span className="text-gray-200 text-xs">—</span>}
                                            </td>
                                        </>}
                            ...
                            return (
                                <tr key={l.id} className={`${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'} ${temEvento ? 'bg-amber-50' : ''}`}>
                                    ...
                                    {indiceEscolhido && <>
                                        ...
                                        <td className={`border border-gray-300 px-2 py-1 text-right font-bold ${temSplit ? 'text-orange-600' : ''}`}>{temSplit ? `+ ${formatCurrency(l.correcao_split)}` : '-'}</td>
                                    </>}
