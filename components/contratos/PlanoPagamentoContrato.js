...
import { faSpinner, faSave, faCalculator, faInfoCircle } from '@fortawesome/free-solid-svg-icons';
...
export default function PlanoPagamentoContrato({ contrato, onRecalculateSuccess }) {
    ...
    const handlePlanoChange = (name, value) => {
        ...
        if (name.includes('_percentual')) {
            ...
            newPlanoState[name] = value; // Mantém o valor como string para o input
            if (baseValue > 0) {
