...
export default function ContratoForm() {
 ...
 empreendimento_id: '',
 produto_id: '',
 tipo_documento: 'TERMO_DE_INTERESSE', data_venda: new Date().toISOString().split('T')[0],
 valor_final_venda: '',
 contato_id: null,
 corretor_id: null,
 });
 ...
 tipo_documento: formData.tipo_documento, status_contrato: 'Rascunho', // <--- MUDANÇA AQUI: Nasce como Rascunho
