...
import { 
    ...
    faCalculator // --- ÍCONE ADICIONADO AQUI ---
...
export default function ContratoManager({ initialContratoData, onUpdate }) {
    ...
    useEffect(() => {
        ...
        setSearchTerms({
            comprador: initialContratoData.contato?.nome || initialContratoData.contato?.razao_social || '',
            corretor: initialContratoData.corretor?.nome || initialContratoData.corretor?.razao_social || '',
        });
    }, [initialContratoData]);
        ...
        <div className="space-y-8">
            ...
            <div className="border-b border-gray-200">
                <nav className="flex gap-4">
                    ...
                    <TabButton tabId="plano_pagamento" label="Plano de Pagamento" icon={faCalculator} />
            ...
            <div>
                {activeTab === 'resumo' && (
                    <div className="bg-white p-6 rounded-lg shadow-md border animate-fade-in space-y-6">
                        ...
                        <fieldset className="grid grid-cols-1 md:grid-cols-2 gap-6">
                             <SearchableField label="Cliente / Comprador" selectedName={searchTerms.comprador} onClear={() => handleClearContato('comprador')}>
                            ...
                            <SearchableField label="Corretor Responsável" selectedName={searchTerms.corretor} onClear={() => handleClearContato('corretor')}>
                               <div className="relative">
                ...
                {activeTab === 'cronograma' && (
                    <div className="animate-fade-in">
                        <CronogramaFinanceiro contratoId={contrato.id} parcelas={contrato.contrato_parcelas} valorTotalContrato={contrato.valor_final_venda} onUpdate={onUpdate} />
                    </div>
                )}
