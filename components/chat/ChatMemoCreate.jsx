                    ...
                    return (
                        ...
                        >
                            ...
                            {contact.avatar_url ? (
                                ...
                                <div className="w-10 h-10 shrink-0 rounded-full bg-gradient-to-br from-gray-700 to-black flex items-center justify-center text-white font-bold shadow-sm">
                                    {initial}
                                </div>
                            )}
