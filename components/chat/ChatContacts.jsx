...
export default function ChatContacts({ onSelectContact }) {
    ...
    return (
        <div className="flex-1 overflow-y-auto w-full p-2 space-y-1">
            ...
            <div 
                onClick={() => onSelectContact({ isBroadcast: true })}
                ...
                return (
                    ...
                    >
                        ...
                        {contact.avatar_url ? (
                            ...
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gray-700 to-black flex items-center justify-center text-white font-bold shadow-sm group-hover:shadow-md transition-all">
                                {initial}
                            </div>
                        )}
