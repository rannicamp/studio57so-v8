...
export default function ChatConversations({ onSelectConversation }) {
 ...
 <div className="w-12 h-12 shrink-0 rounded-full bg-blue-600 text-white to-black flex items-center justify-center text-white font-bold shadow-sm group-hover:shadow-md transition-all">
 {initial}
 </div>
 )}
 {/* Info */}
