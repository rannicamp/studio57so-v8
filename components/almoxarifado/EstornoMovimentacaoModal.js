...
export default function EstornoMovimentacaoModal({ isOpen, onClose, movimentacao, onSuccess }) {
 ...
 <div className="flex justify-between items-center p-4 border-b border-blue-600 bg-blue-600 rounded-t-lg">
 ...
 className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-600 disabled:opacity-50 flex items-center gap-2"
 >
