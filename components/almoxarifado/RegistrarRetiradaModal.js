...
// O PORQUÊ: A lógica foi movida para o Supabase (RPC) 'registrar_retirada_estoque'.
// Antes, se 2 usuários dessem baixa juntos, quem terminava de salvar por último
// apagava a subtração do primeiro. Agora o PostgreSQL processa na fila e impede fraudes!
// =================================================================================
const registrarRetiradaEquipamento = async ({ supabase, estoqueItem, quantidade, observacao, usuarioId, funcionarioId, organizacaoId }) => {
 const { error } = await supabase.rpc('registrar_retirada_estoque', {
