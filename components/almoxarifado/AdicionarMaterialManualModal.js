...
export default function AdicionarMaterialManualModal({ isOpen, onClose, onSuccess, empreendimentoId }) {
 ...
 .from('materiais')
 .insert({ nome: searchTerm.trim(), descricao: searchTerm.trim(),
 ...
 <div className="p-3">
 <button type="button" onClick={handleCreateAndSelectMaterial} className="text-blue-600 font-semibold flex items-center gap-2 w-full text-left hover:text-blue-800"
 ...
 disabled={isItemSelected} className="mt-1 w-full p-2 border rounded-md disabled:bg-gray-200"
 />
 </div>
 <div>
