...
import { faSpinner, faArrowUp, faArrowDown, faFilter, faUser, faCalendarAlt,
 faSearch,
...
export default function PainelMovimentacoes({ empreendimentoId }) {
 ...
 <EstornoMovimentacaoModal isOpen={modalEstornoOpen}
 ...
 <FontAwesomeIcon icon={faSpinner} spin className="text-3xl mb-3 text-blue-500" /> <p>Consultando banco de dados...</p>
 </div>
 ) : isError ? (
 ...
 <button onClick={() => handleAbrirEstorno(mov)}
 className="text-blue-600 hover:text-blue-600 bg-blue-600 hover:bg-blue-600 p-2 rounded-md transition-colors"
