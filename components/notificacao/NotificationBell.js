...
import { faBell, faCheck, faInbox, faMoneyBillWave, faHardHat, faExclamationTriangle, faBullhorn, faCheckCircle, faCommentDots } from '@fortawesome/free-solid-svg-icons';
...
const TIPO_CONFIG = {
 ...
 obras: { icon: faHardHat, color: 'text-blue-600', bg: 'bg-blue-600' },
