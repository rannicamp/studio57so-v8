...
export default function NotificationManager() {
 ...
 const [permission, setPermission] = useState('default'); const supabase = createClient();
 ...
 ${isSubscribed ? 'bg-green-100 text-green-700 hover:bg-green-200 border border-green-200' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 border border-gray-200'}
