...
// 1. Remover texto do mapa
content = content.replace(
  `<div className="w-full text-center px-4 mb-8">\n  <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Trajeto Estratégico</h2>\n  <p className="max-w-2xl mx-auto text-gray-400">\n  Confira as facilidades e conveniências ao redor do Alto Esplanada.\n  </p>\n  </div>`,
  ''
);
...
content = content.replace(/\/\/ --- DADOS DAS PLANTAS ---[\s\S]*?\n\];/, newArrays);

// 3. Substituir Layouts Inteligentes pela nova seção
...
content = content.replace(/<section className="py-16 md:py-24 bg-black">[\s\S]*?\{\/\* --- GALERIA COMPLETA ---\*\/\}/, novaSecao + '\\n {/* --- GALERIA COMPLETA --- */}');

fs.writeFileSync(filePath, content, 'utf8');
console.log('Update successful com replace seguro!');
