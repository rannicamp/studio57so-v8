...
BEGIN
  ...
  -- 2. Calcular o VGV Total (Regra de Ouro: Estoque Listado + Contratos)
  DECLARE
  ...
  -- 3. Calcular o Patrimônio VGV Construído
  v_patrimonio_vgv := v_vgv_total * (v_percentual_executado / 100.0);

  -- 4. Atualizar o empreendimento com os valores recalculados
