...
3. **Verificação Matinal de Tickets e Feedbacks (Triagem Obrigatória):**
   - **MUITO IMPORTANTE:** Ao iniciar o dia, você DEVE automaticamente acionar o workflow de triagem. Para isso, comporte-se como se o usuário tivesse digitado `/triagem-bugs`. 
   - Leia e execute fielmente todos os passos definidos no arquivo `.agents/workflows/triagem-bugs.md`. Isso garantirá que o dia comece com o mapa claro de prioridades pendentes reportadas pela equipe.

4. **Atualize o Schema do Banco de Dados (`dbelo57.sql`):**
...
5. **Revise a Regra Suprema de UI/UX:**
...
6. **Estude o Código de Referência (Módulo Padrão Ouro):**
...
7. **Revise as Regras Inquebráveis de Banco de Dados:**
...
8. **Regras de Encerramento e Deploy:**
...
10. **Blindagem Anti-Crash do Supabase (Edge Middleware):**
...
11. **Aguarde o Comando de Partida:**
...
12. **Sempre use Links Clicáveis para Arquivos:**
...
13. **Revisão do Relatório de Dívida Técnica:**
...
14. **Cristalização de Conhecimento Autônomo (Meta-Skill):**
