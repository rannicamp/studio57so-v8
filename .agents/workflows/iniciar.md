...
2. **Atualize o Schema do Banco de Dados (`dbelo57.sql`):**
...
3. **Revise o Manual Supremo de UI/UX:**
...
4. **Estude o Código de Referência (Módulo Padrão Ouro):**
...
5. **Revise as Regras Inquebráveis de Banco de Dados:**
...
6. **Regras de Encerramento e Deploy:**
...
8. **Blindagem Anti-Crash do Supabase (Edge Middleware):**
...
9. **Aguarde o Comando de Partida:**
