...
async function main() {
  ...
  const configsRes = await client.query(`
    SELECT id, organizacao_id, whatsapp_phone_number_id, whatsapp_business_account_id, is_active
  ...
  const msgRes = await client.query(`
    SELECT id, contato_id, content, direction, status, sent_at, raw_payload, error_message
