...
- [ ] **Previsão de Situação de Afastamento (INSS):** Prever quando o funcionário está afastado/encostado pelo INSS (continua no quadro de funcionários sem ser demitido, mas não está trabalhando). O sistema deve permitir sinalizar essa situação especial do colaborador, suspendendo a geração de pontos, provisões de vales e cálculos automáticos de folha enquanto durar o afastamento.
