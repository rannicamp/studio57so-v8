...
async function runSQL() {
  const connStr = `postgresql://postgres:${process.env.SUPABASE_DB_PASSWORD ? encodeURIComponent(process.env.SUPABASE_DB_PASSWORD) : 'REMOVED_PASSWORD'}@db.vhuvnutzklhskkwbpxdz.supabase.co:5432/postgres`;
...
$function$;
     ...
     console.log("Sucesso! RPC atualizada com dia_semana em leads_por_hora.");
  } catch (e) {
